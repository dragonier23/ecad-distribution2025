...
void Vtb_timer___024root__trace_chg_0_sub_0(Vtb_timer___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vtb_timer___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_timer___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vtb_timer___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vtb_timer___024root__trace_chg_0_sub_0(Vtb_timer___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_timer___024root__trace_chg_0_sub_0\n"); );
    Vtb_timer__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    ...
    bufp->chgQData(oldp+2,(vlSelfRef.t),64);
}

void Vtb_timer___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_timer___024root__trace_cleanup\n"); );
    // Init
    Vtb_timer___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtb_timer___024root*>(voidSelf);
